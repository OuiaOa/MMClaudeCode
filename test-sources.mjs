#!/usr/bin/env node
/**
 * Tests for bin/dsv4f-sources.mjs — detection of Claude Code CLI, Claude Desktop, and
...
} from './bin/dsv4f-sources.mjs';

const require = createRequire(import.meta.url);
const SCRATCH = fs.mkdtempSync(path.join(os.tmpdir(), 'dsv4f-sources-test-'));
...
console.log('\n\x1b[1mdsv4f-sources tests\x1b[0m\n');
...
console.log('\n\x1b[1mplatform-specific path resolution\x1b[0m');
{
  ...
  // against PC-4D's actual filesystem in dsv4f-multi-source-import notes.
