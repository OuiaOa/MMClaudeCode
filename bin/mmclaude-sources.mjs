#!/usr/bin/env node
/**
 * mmclaude-sources — detect the tools whose history can be brought into mmclaude, and
 ...
 *                   that mmclaude now shares with the CLI.
 *
 ...
 *
 * Usage:
 *   mmclaude-sources           human-readable report
 *   mmclaude-sources --json    machine-readable, for the installer/setup to consume
 */
