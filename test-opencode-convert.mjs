#!/usr/bin/env node
/**
 * Tests for bin/mmclaude-opencode-convert.mjs against a synthetic SQLite fixture built to
 ...
 * <converted-uuid> --print` and getting back a real, correct MiniMax reply (is_error:
...
} from './bin/mmclaude-opencode-convert.mjs';

const require = createRequire(import.meta.url);
const DatabaseSync = (() => { try { return require('node:sqlite').DatabaseSync; } catch { return null; } })();

const SCRATCH = fs.mkdtempSync(path.join(os.tmpdir(), 'mmclaude-oc-convert-test-'));
...
console.log('\n\x1b[1mmmclaude-opencode-convert tests\x1b[0m\n');
